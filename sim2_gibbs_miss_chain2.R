# Simulation study 2 - Gibbs - misspecified
...
tp <- run_sims_gibbs(S = 100, seed = 2024, save_folder = "Simulation2_Gibbs_miss_paper",
                     scenario = 2, m = 5, 
                     times = 100, ordem = 4, K = 10, coef = coef, sigma = 0.2, mu_ki = 0.5, 
                     lambda1 = 0, lambda2 = 0, delta1 = 0, delta2 = 0, 
                     maxIter = 10000, initial_values = initial_values2, w = 6, 
                     corr = "miss", basis_type = "B-splines")

write(tp, file = paste0("Simulation2_Gibbs_miss_paper/", "chain", 2, "/tempo", ".txt"))

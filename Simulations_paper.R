...
tp1 <- run_sims(S = 100, seed = 2024, save_folder = "Simulation4_corr_w", scenario = 1, m = 5, times = 100, ordem = 4, K = 10, coef = coef, sigma = 0.1, mu_ki = 0.5, lambda_1 = 1e-6, lambda_2 = 1e-6, delta_1 = 100, delta_2 = 99*(0.1^2), maxIter = 100, initial_values = initial_values, convergence_threshold = 0.001, w = 6, corr = TRUE, basis_type = "Fourier")

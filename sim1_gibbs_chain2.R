...
tp1 <- run_sims_gibbs(S = 50, seed = 3000, save_folder = "Simulation1_Gibbs", scenario = 2, m = 5, 
                      times = 100, ordem = 4, K = 10, coef = coef, sigma = 0.1, mu_ki = 0.7, 
                      lambda1 = 0, lambda2 = 0, delta1 = 0, delta2 = 0, 
                      maxIter = 10000, initial_values = initial_values2)

write(tp1, file = paste0("Simulation1_Gibbs/", "chain", 2, "/tempo", ".txt"))

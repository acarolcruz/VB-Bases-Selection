run_gibbs <- function(sim = sim, save_folder = save_folder, scenario = scenario, m = m, times = times, 
                      ordem = ordem, K = K, coef = coef, seed = seed, sigma = sigma, mu_ki = mu_ki, 
                      lambda1 = lambda1, lambda2 = lambda2, delta1 = delta1, delta2 = delta2, maxIter = maxIter,
